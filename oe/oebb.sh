...
# This script is cloned from the angstrom distribution!
...
BASE_VERSION=3
OE_ENV_FILE=${OE_BASE}/../environment-oecore
...
if [ -e ${OE_ENV_FILE} ] ; then
    ...
    echo "Run ./atto-shell.sh to start up the OE environment"
fi # if -e ${OE_ENV_FILE}
}
...
function update_oe()
{
    ...
    #manage meta-openembedded and meta-atto with layerman
